...
debugStream :: BSStream IO -> BSStream IO
debugStream inner =
...
debugBsGetLine :: BSStream IO -> IO BS.ByteString
debugBsGetLine s = do
...
debugBsGet :: BSStream IO -> Int -> IO BS.ByteString
debugBsGet s len = do
...
debugBsPut :: BSStream IO -> BS.ByteString -> IO ()
debugBsPut s str = do
